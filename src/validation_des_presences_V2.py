from functions.id_number_detection_functions import read_student_id_v2
...
for form in source_dir:
    ...
    for current_presence_page in presence_pages:
        ...
        the_small_boxes_for_the_id_number = find_square_boxes(img_binaire, img_binaire.shape)

        student_id, grid_info = read_student_id_v2(img_binaire,the_small_boxes_for_the_id_number,img_binaire.shape,min_ratio=1.8)
        if student_id == None:
